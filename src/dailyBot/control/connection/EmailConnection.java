...
public class EmailConnection
{
	...
	private static final String username = DailyProperties.getProperty("dailyBot.control.connection.EmailConnection.emailFrom");
	private static final String emailFromAddress = DailyProperties.getProperty("dailyBot.control.connection.EmailConnection.emailFrom");
	private static final String[] emailList = {DailyProperties.getProperty("dailyBot.control.connection.EmailConnection.emailTo")};
		...
		Session session = Session.getDefaultInstance(properties, new Authenticator()
															{
																...
																{
																	return new PasswordAuthentication(username, DailyProperties.getProperty("dailyBot.control.connection.EmailConnection.emailFromPassword"));
																}
															}
													);
		return session;
